...
public class OperationLogAspect {
    ...
    public Object doAround(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        operationLog.setBasePath(StrUtil.removeSuffix(urlStr, URLUtil.url(urlStr).getPath()));
        operationLog.setIp(request.getRemoteUser());
        operationLog.setMethod(request.getMethod());
        operationLog.setParameter(getParameter(method, joinPoint.getArgs()));
        operationLog.setResult(result);
        operationLog.setSpendTime((int) (endTime - startTime));
